        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">All Portfolios</a></li>
    ...
    <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php foreach($porjects as $porject): ?>
                  <tr>
                    <td><?php echo $porject["description"] ?></td>
                    <td><?php echo $porject["name"] ?></td>
                    <td><img src="upload/<?php echo $porject["image"] ?>" style=" width: 250px;height: 200px;"></td>
                    <td><a href="updateportfolio.php?projectid=<?php echo $porject["id"] ?>" class="btn btn-secondary">Update</a></td>
                    ...
                    <td><a href="deleteportfolio.php?projectid=<?php echo $porject["id"]; ?>" class="btn btn-danger">Delete</a></td>
                  </tr>
                  <?php endforeach; ?>
                  </tbody>
                  <tfoot>
