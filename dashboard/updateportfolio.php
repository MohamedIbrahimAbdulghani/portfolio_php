...
if(isset($_POST["description"])) {
    ...
    if(isset($_FILES["image"]["name"])) {
      ...
      move_uploaded_file($file_name, "upload/".$image_name);
    } else {
      $file_name = "";
    }
    ...
    if($result == true) {
      ...
      $result = "Project is not inserted";
    }
        ...
        <div class="card card-primary">
              ...
              <form action="<?php echo $_SERVER["PHP_SELF"]?>" method="POST" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                        ...
                        <textarea class="form-control" id="summernote" placeholder="Enter Message" name="description"><?php echo $data["description"] ?></textarea>
                      </div>
                      <img src="upload/<?php echo $data["image"] ?>" style="width: 25%" alt="">
                  <div class="form-group">
